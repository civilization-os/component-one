...
const motionProfile = {"highlight":{"enter":{"delayMs":110,"durationMs":360,"easing":"ease-out"},"exit":{"delayMs":30,"durationMs":260,"easing":"ease-in"}},"appear":{"enter":{"delayMs":210,"durationMs":620,"easing":"cubic-bezier(0.16, 1, 0.3, 1)"},"exit":{"delayMs":20,"durationMs":240,"easing":"ease-in"}},"spotlight":{"enter":{"delayMs":90,"durationMs":420,"easing":"ease-out"},"exit":{"delayMs":10,"durationMs":240,"easing":"ease-in"}},"laser":{"enter":{"delayMs":260,"durationMs":700,"easing":"cubic-bezier(0.22, 1, 0.36, 1)"},"exit":{"delayMs":10,"durationMs":250,"easing":"ease-in"}},"byBlockKind":{"comparison":{"highlight":{"enter":{"delayMs":130,"durationMs":390,"easing":"ease-out"},"exit":{"delayMs":30,"durationMs":270,"easing":"ease-in"}},"appear":{"enter":{"delayMs":240,"durationMs":660,"easing":"cubic-bezier(0.16, 1, 0.3, 1)"},"exit":{"delayMs":20,"durationMs":250,"easing":"ease-in"}}},"timeline":{"spotlight":{"enter":{"delayMs":100,"durationMs":450,"easing":"ease-out"},"exit":{"delayMs":10,"durationMs":250,"easing":"ease-in"}},"laser":{"enter":{"delayMs":280,"durationMs":760,"easing":"cubic-bezier(0.22, 1, 0.36, 1)"},"exit":{"delayMs":10,"durationMs":260,"easing":"ease-in"}}}}};
...
function currentRenderState(actions, guidance) {
  ...
  // emphasized = only what's being actively highlighted (for overlay rendering)
  const emphasizedIds = focusMode ? new Set([...highlightedIds, ...guidanceTargetIds]) : new Set([]);
